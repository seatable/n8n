		...
		description: INodeTypeDescription = {
				...
				properties: [
						...
						// ----------------------------------
						{
								...
								default: true,
								description: 'Whether all or a limited number of rows are returned',
						},
						{
								displayName: 'Limit',
								name: 'limit',
								...
								options: [
										{
												...
												type: 'string',
												default: '',
												description: 'Additional columns to be included in the response. <br><br>By default the standard (always first) column is returned, this field allows to add one or more additional fields.<br><br><ul><li>Multiple can be separated by comma. Example: <samp>Title,Surname</samp>.',
										},
								],
						},
				],
